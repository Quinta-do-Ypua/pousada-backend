...
class MeioPagamentoServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new MeioPagamentoService(repository);
        mockFactory = new MockFactory();
    }

    @Nested
    class Dado_um_meio_pagamento_novo {

        private MeioPagamento novo;

        @BeforeEach
        void setUp() {
            novo = mockFactory.novoMeioPagamento();
        }
        ...
        class Quando_salvar {
            ...
            @Test
            void Entao_deve_criar_o_meio_pagamento() {
                MeioPagamento resultado = service.salvar(novo);
    ...
    class Dado_um_meio_pagamento_existente {
        ...
        private MeioPagamento existente;

        @BeforeEach
        void setUp() {
            existente = mockFactory.meioPagamentoExistente();
        }
        ...
        class Quando_salvar {
            ...
            @Test
            void Entao_deve_atualizar_o_meio_pagamento() {
                MeioPagamento resultado = service.salvar(existente);
    ...
    @Nested
    class Dado_uma_lista_de_meios_pagamento {
        ...
        void setUp() {
            meiosPagamento = List.of(
                mockFactory.novoMeioPagamento(),
                mockFactory.meioPagamentoComIdENome(2L, "PIX")
            );
        }
        ...
        class Quando_salvar_em_lote {
            ...
            @Test
            void Entao_deve_criar_todos_os_meios_pagamento() {
                List<MeioPagamento> resultado = service.salvarEmLote(meiosPagamento);
    ...
    class Dado_um_id_existente {
        ...
        class Quando_buscar_por_id {
            ...
            @Test
            void Entao_deve_retornar_o_meio_pagamento() {
                MeioPagamento resultado = service.buscarPorId(1L);
        ...
        class Quando_excluir {
            ...
            @Test
            void Entao_deve_remover_o_meio_pagamento() {
                MeioPagamento resultado = service.excluir(1L);
    ...
    class Dada_uma_paginacao {
        ...
        class Quando_listar_paginado {
            ...
            @Test
            void Entao_deve_retornar_a_lista_de_meios_pagamento() {
    ...
    class Dada_uma_specification_nula {
        ...
        class Quando_buscar_por_specification {
            ...
            @BeforeEach
            void setUp() {
                when(repository.findAll((Specification<MeioPagamento>) null, pageable))
                        .thenReturn(new PageImpl<>(List.of()));
            }

            @Test
            void Entao_deve_retornar_todos_os_meios_pagamento() {
